...
function App() {
  ...
  const [passwordCreated, setPasswordCreated] = useState(true);
  const [passwordConfig, setPasswordConfig] = useState({
    numbers: true,
    uppercase: true,
    lowercase: true,
    symbols: true, // Disable symbols
    length: 16,
  });

  function makePassword() {
    setPasswordCreated(false);
    setPassword(passfather(passwordConfig));
  }
  console.log("passwordConfig.numbers: " + passwordConfig.numbers);
  console.log("passwordConfig.uppercase: " + passwordConfig.uppercase);
  console.log("passwordConfig.lowercase: " + passwordConfig.lowercase);
  console.log("passwordConfig.symbols: " + passwordConfig.symbols);
      ...
      <div>
        <Card variant="subtle" color="pink" p="md" m="md">
          ...
          <Text align="center" as="p">
            {passwordCreated ? "Press generate " : password}{" "}
            <a
              onClick={() => {
                copy();
                notify();
